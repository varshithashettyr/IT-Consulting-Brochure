...
export function ServicesExplorer() {
  ...
  const baseKeyServices: KeyService[] = [
  {
    ...
    icon: Target,
    subServices: [
      ["Business and Technology Assessment", SearchCheck],
      ["Digital Vision and IT Strategy Definition", Lightbulb],
      ["Roadmap and Architecture Design", Map],
      ["Technology Selection and Solution Planning", Layers],
      ["Implementation and Change Enablement", RefreshCw],
...

  {
    ...
    icon: Lightbulb,
    subServices: [
      ["Technology Requirements Assessment", ClipboardCheck],
      ["Solution Architecture and Design", Network],
      ["Enterprise Technology Evaluation", MonitorCheck],
      ["Vendor Selection and Due Diligence", UserCheck],
      ["Proof of Concept (PoC) Development", FlaskConical],
...

  {
    ...
    icon: MonitorCog,
    subServices: [
      ["Enterprise Application Assessment", SearchCheck],
      ["Legacy System Modernization", RefreshCw],
...

  {
    ...
    subServices: [
      ...
      ["Vulnerability and Threat Analysis", ShieldAlert],
      ["Regulatory and Compliance Mapping", Scale],
      ["Security Architecture and Controls", LockKeyhole],
...

  {
    ...
    icon: Workflow,
    subServices: [
      ["Business Process Assessment", ClipboardCheck],
      ["Process Gap and Efficiency Analysis", SearchCheck],
      ["Workflow Optimization Recommendations", Workflow],
      ["RPA and Low-Code Automation Advisory", Bot],
...

  {
    ...
    icon: UsersRound,
    subServices: [
      ["Stakeholder Analysis and Engagement Planning", Users],
      ["Change Communication Strategy", MessageSquare],
      ["End-User Readiness Assessments", UserCheck],
      ["Training Needs Analysis", GraduationCap],
      ["Remote Training and Enablement", MonitorCheck],
